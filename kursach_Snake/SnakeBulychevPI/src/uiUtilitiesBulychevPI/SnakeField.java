...
public class SnakeField extends JPanel implements Serializable, KeyListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (stop) {
            ...
            g.drawString("...Игра окончена...", 140, 150);
        } else {
            if (play) {
                sleep(speed);
                ...
                checkFoodCollision(parent.eatAll);
    ...
    private void checkFoodCollision(boolean eat_all) {
        for (int f = 0; f < food.size(); f++) {
